...
public class StudentOperationsController {
	...
	@GetMapping("/register")
	public String showStydentFormPage(@ModelAttribute("stud") Student st) {//for lunching form page
	...
	public String registerStudent(Map<String,Object> map,
			                       @ModelAttribute("stud") Student st) //for processing form page submission 
	{
