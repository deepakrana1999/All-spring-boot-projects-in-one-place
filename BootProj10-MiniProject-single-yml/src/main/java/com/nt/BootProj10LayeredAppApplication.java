...
public class BootProj10LayeredAppApplication {
	...
	public static void main(String[] args) {
		...
		//@ComponentScan
		SpringApplication application=new SpringApplication(BootProj10LayeredAppApplication.class);
		//hard cording of profile 
		application.setAdditionalProfiles("dev");
		try
		(ConfigurableApplicationContext ctx = application.run( args);Scanner sc=new Scanner(System.in))
		{
