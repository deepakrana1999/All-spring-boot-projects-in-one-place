...
public class BootProj03LayeredAppApplication2 {

	public static void main(String[] args) {
		//get access to IOC Container
		try
		(ConfigurableApplicationContext ctx = SpringApplication.run(BootProj03LayeredAppApplication2.class, args);Scanner sc=new Scanner(System.in))
		{
