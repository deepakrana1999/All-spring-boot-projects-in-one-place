...
public class BootProj09LayeredAppApplication {
	...
	public static void main(String[] args) {
		...
		//@ComponentScan
		try
		(ConfigurableApplicationContext ctx = SpringApplication.run(BootProj09LayeredAppApplication.class, args);Scanner sc=new Scanner(System.in))
		{
