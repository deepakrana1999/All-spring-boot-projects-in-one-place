...
public class BootProj08LayeredAppApplication {
	...
	public static void main(String[] args) {
		...
		//@ComponentScan
		try
		(ConfigurableApplicationContext ctx = SpringApplication.run(BootProj08LayeredAppApplication.class, args);Scanner sc=new Scanner(System.in))
		{
